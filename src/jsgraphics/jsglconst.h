...
//OpenGL extensions
		...
		CONST_INTEGER( FRAGMENT_SHADER_ARB                 ,GL_FRAGMENT_SHADER_ARB                 )
		CONST_INTEGER( MAX_FRAGMENT_UNIFORM_COMPONENTS_ARB ,GL_MAX_FRAGMENT_UNIFORM_COMPONENTS_ARB )
		CONST_INTEGER( FRAGMENT_SHADER_DERIVATIVE_HINT_ARB ,GL_FRAGMENT_SHADER_DERIVATIVE_HINT_ARB )
		#endif
