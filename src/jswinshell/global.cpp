...
CONFIGURE_STATIC
	...
	BEGIN_STATIC_PROPERTY_SPEC
		PROPERTY( clipboard )
		PROPERTY_GET( systemCodepage )
		PROPERTY_GET( consoleCodepage )

		PROPERTY( numlockState )
		PROPERTY( capslockState )
		PROPERTY( scrolllockState )

		PROPERTY_GET( lastInputTime )

		PROPERTY_SWITCH_GET( ADMINTOOLS, folderPath )
		PROPERTY_SWITCH_GET( ALTSTARTUP, folderPath )
		PROPERTY_SWITCH_GET( APPDATA, folderPath )
		PROPERTY_SWITCH_GET( BITBUCKET, folderPath )
		PROPERTY_SWITCH_GET( CDBURN_AREA, folderPath )
		PROPERTY_SWITCH_GET( COMMON_ADMINTOOLS, folderPath )
		PROPERTY_SWITCH_GET( COMMON_ALTSTARTUP, folderPath )
		PROPERTY_SWITCH_GET( COMMON_APPDATA, folderPath )
		PROPERTY_SWITCH_GET( COMMON_DESKTOPDIRECTORY, folderPath )
		PROPERTY_SWITCH_GET( COMMON_DOCUMENTS, folderPath )
		PROPERTY_SWITCH_GET( COMMON_FAVORITES, folderPath )
		PROPERTY_SWITCH_GET( COMMON_MUSIC, folderPath )
		PROPERTY_SWITCH_GET( COMMON_OEM_LINKS, folderPath )
		PROPERTY_SWITCH_GET( COMMON_PICTURES, folderPath )
		PROPERTY_SWITCH_GET( COMMON_PROGRAMS, folderPath )
		PROPERTY_SWITCH_GET( COMMON_STARTMENU, folderPath )
		PROPERTY_SWITCH_GET( COMMON_STARTUP, folderPath )
		PROPERTY_SWITCH_GET( COMMON_TEMPLATES, folderPath )
		PROPERTY_SWITCH_GET( COMMON_VIDEO, folderPath )
		PROPERTY_SWITCH_GET( COMPUTERSNEARME, folderPath )
		PROPERTY_SWITCH_GET( CONNECTIONS, folderPath )
		PROPERTY_SWITCH_GET( CONTROLS, folderPath )
		PROPERTY_SWITCH_GET( COOKIES, folderPath )
		PROPERTY_SWITCH_GET( DESKTOP, folderPath )
		PROPERTY_SWITCH_GET( DESKTOPDIRECTORY, folderPath )
		PROPERTY_SWITCH_GET( DRIVES, folderPath )
		PROPERTY_SWITCH_GET( FAVORITES, folderPath )
		PROPERTY_SWITCH_GET( FONTS, folderPath )
		PROPERTY_SWITCH_GET( HISTORY, folderPath )
		PROPERTY_SWITCH_GET( INTERNET, folderPath )
		PROPERTY_SWITCH_GET( INTERNET_CACHE, folderPath )
		PROPERTY_SWITCH_GET( LOCAL_APPDATA, folderPath )
		PROPERTY_SWITCH_GET( MYDOCUMENTS, folderPath )
		PROPERTY_SWITCH_GET( MYMUSIC, folderPath )
		PROPERTY_SWITCH_GET( MYPICTURES, folderPath )
		PROPERTY_SWITCH_GET( MYVIDEO, folderPath )
		PROPERTY_SWITCH_GET( NETHOOD, folderPath )
		PROPERTY_SWITCH_GET( NETWORK, folderPath )
		PROPERTY_SWITCH_GET( PERSONAL, folderPath )
		PROPERTY_SWITCH_GET( PRINTERS, folderPath )
		PROPERTY_SWITCH_GET( PRINTHOOD, folderPath )
		PROPERTY_SWITCH_GET( PROFILE, folderPath )
		PROPERTY_SWITCH_GET( PROGRAM_FILES, folderPath )
		PROPERTY_SWITCH_GET( PROGRAM_FILESX86, folderPath )
		PROPERTY_SWITCH_GET( PROGRAM_FILES_COMMON, folderPath )
		PROPERTY_SWITCH_GET( PROGRAM_FILES_COMMONX86, folderPath )
		PROPERTY_SWITCH_GET( PROGRAMS, folderPath )
		PROPERTY_SWITCH_GET( RECENT, folderPath )
		PROPERTY_SWITCH_GET( RESOURCES, folderPath )
		PROPERTY_SWITCH_GET( RESOURCES_LOCALIZED, folderPath )
		PROPERTY_SWITCH_GET( SENDTO, folderPath )
		PROPERTY_SWITCH_GET( STARTMENU, folderPath )
		PROPERTY_SWITCH_GET( STARTUP, folderPath )
		PROPERTY_SWITCH_GET( SYSTEM, folderPath )
		PROPERTY_SWITCH_GET( SYSTEMX86, folderPath )
		PROPERTY_SWITCH_GET( TEMPLATES, folderPath )
		PROPERTY_SWITCH_GET( WINDOWS, folderPath )
