...
CONFIGURE_CLASS
	...
	BEGIN_PROPERTY_SPEC
		...
		PROPERTY_GET( hostLanguage )
		PROPERTY_GET( directory )
		PROPERTY_GET( canProcessReplacing )

		PROPERTY_SET( numPrograms )
		PROPERTY_SET( numParams )
		PROPERTY_SET( numInputs )
		PROPERTY_SET( numOutputs )
		PROPERTY_SET( uniqueID )

		PROPERTY_SET( inputLatency )
		PROPERTY_SET( outputLatency )

		PROPERTY_GET( samplePos )
		PROPERTY_GET( sampleRate )
		PROPERTY_GET( nanoSeconds )
		PROPERTY_GET( ppqPos )
		PROPERTY_GET( tempo )
		PROPERTY_GET( barStartPos )
		PROPERTY_GET( cycleStartPos )
		PROPERTY_GET( cycleEndPos )
		PROPERTY_GET( timeSigNumerator )
		PROPERTY_GET( timeSigDenominator )
		PROPERTY_GET( smpteOffset )
		PROPERTY_GET( smpteFrameRate )
		PROPERTY_GET( samplesToNextClock )
		PROPERTY_SET( initialDelay )
