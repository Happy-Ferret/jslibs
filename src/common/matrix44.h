...
#else // SSE
	jl::memcpy(m->raw, Matrix44IdentityValue.raw, sizeof(Matrix44IdentityValue));
#endif // SSE
...
inline void Matrix44Load( Matrix44 *m, const Matrix44 *m1 ) {
	...
	m->m4 = m1->m4;
#else // SSE
	jl::memcpy(m->raw, m1->raw, sizeof(Matrix44));
#endif // SSE
...
#else // SSE
	jl::memcpy(m->raw, ptr, sizeof(Matrix44));
#endif // SSE
...
#else // SSE
	jl::memcpy(ptr, m->raw, sizeof(Matrix44));
#endif // SSE
