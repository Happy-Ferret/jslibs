...
//		FUNCTION( ToggleFullScreen )
	...
	BEGIN_STATIC_PROPERTY_SPEC
		...
		PROPERTY_GET( desktopWidth )
		PROPERTY_GET( desktopHeight )
		PROPERTY_GET( desktopBitsPerPixel )
		PROPERTY_GET( videoWidth )
		PROPERTY_GET( videoHeight )
		PROPERTY_GET( videoBitsPerPixel )
		PROPERTY_GET( videoFlags )
		PROPERTY_GET( videoDriverName )
//		PROPERTY_GET( isFullScreen )
		PROPERTY_GET( mouseX )
		PROPERTY_GET( mouseY )
		PROPERTY_GET( buttonState )
		PROPERTY_GET( modifierState )
		PROPERTY_GET( appStateActive )

		PROPERTY_GET(hasRDTSC)
		PROPERTY_GET(hasMMX)
		PROPERTY_GET(hasMMXExt)
		PROPERTY_GET(has3DNow)
		PROPERTY_GET(has3DNowExt)
		PROPERTY_GET(hasSSE)
		PROPERTY_GET(hasSSE2)
		PROPERTY_GET(hasAltiVec)
