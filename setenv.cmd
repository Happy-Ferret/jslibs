...
set PATH=%PATH%;%CD%\src\jshost\%BUILD%;%CD%\src\jswinhost\%BUILD%;%CD%\src\jslang\%BUILD%;%CD%\src\jsstd\%BUILD%;%CD%\src\jsio\%BUILD%;%CD%\libs\nspr\win32\dist\lib;%CD%\src\jssqlite\%BUILD%;%CD%\src\jsobjex\%BUILD%;%CD%\src\jsz\%BUILD%;%CD%\src\jscrypt\%BUILD%;%CD%\src\jswinshell\%BUILD%;%CD%\src\jsdebug\%BUILD%;%CD%\src\jsimage\%BUILD%;%CD%\src\jssound\%BUILD%;%CD%\src\jsaudio\%BUILD%;%CD%\src\jsfont\%BUILD%;%CD%\src\jsprotex\%BUILD%;%CD%\libs\openal\src\OpenAL-Windows\OpenAL32\Release
